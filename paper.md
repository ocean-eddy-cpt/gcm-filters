...
While we are excited to share GCM Filters in its current beta state at version `0.1.2`, we plan to continue improving and maintaining the package for the long run and welcome new contributors from the broader community.
